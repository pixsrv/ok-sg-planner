...
export const WORK_LENGTH_MINICHART_NONE = 'none';
export const WORK_LENGTH_MINICHART_SEGMENTED = 'segmented-strip';
export const WORK_LENGTH_MINICHART_LOLLIPOP = 'lollipop';
export const WORK_LENGTH_MINICHART_COLORING = 'cell-coloring';

export const WORK_LENGTH_MINICHART_TYPES = [
  {id: WORK_LENGTH_MINICHART_NONE, label: 'None'},
  {id: WORK_LENGTH_MINICHART_SEGMENTED, label: 'Segmented Strip'},
  {id: WORK_LENGTH_MINICHART_LOLLIPOP, label: 'Lollipop Strip'},
